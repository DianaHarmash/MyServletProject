...
<div class="container-fluid">
    <form class="d-flex">
    <button class="btn btn-outline-primary"><a href="/admin/listOfActivity/sortByName?page=prev"><-</a></button>
    </form>
    <button class="btn btn-outline-primary"><a href="/admin/listOfActivity/sortByName?page=next">-></a></button>
    <!--form class="d-flex"-->
    <!--/form-->
</div>
</nav>
