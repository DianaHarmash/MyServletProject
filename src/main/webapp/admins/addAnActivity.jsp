                ...
                <div class = "card text-black" style = "border-radius: 25px;">
                    <div class = "card-body p-md-5"> <div class = "row justify-content-center">
                        <div class = "col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                            <p class = "text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4"><fmt:message key="addNewActivity" bundle="${lang}"/></p>
                            <form action="/admin/listOfActivity/addAnActivity" method="post" class = "mx-1 mx-md-4">
                                ...
                                <div class = "d-flex flex-row align-items-center mb-4">
                                    <i class = "fas fa-lock fa-lg me-3 fa-fw"> </i>
                                    <div class = "form-outline flex-fill mb-0">
                                        <button class="btn btn-outline-primary" type="submit"><fmt:message key="addNewActivity" bundle="${lang}"/></button>
                                    </div>
                                </div>
                            </form>
                        </div>
