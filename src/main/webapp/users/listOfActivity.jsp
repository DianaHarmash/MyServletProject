...
<div class="container">
    <table class="table">
        <thead>
        <tr>
            <th scope="col"><a href="/user/listOfActivity/sortByName"><fmt:message key="name" bundle="${lang}"/></a></th>
            <th scope="col"><a href="/user/listOfActivity/sortByCategory"><fmt:message key="category" bundle="${lang}"/></a></th>
            <th scope="col"><fmt:message key="addNewActivity" bundle="${lang}"/></th>
        </tr>
        </thead>
        <tbody><c:forEach var="activity" items="${requestScope.activities}">
        <tr>
            <th scope="row"><c:out value="${activity.activity}"/></th>
            <td><c:out value="${activity.category}"/></td>
            <td><button class="btn btn-outline-secondary"><a href="/user/listOfActivity/addAnActivity?id=${activity.id}">Add the activity</a></button></td>
        </tr>
        </c:forEach>
        </tbody>
    </table>
